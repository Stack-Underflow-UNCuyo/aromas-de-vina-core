...
import { sampleWithRequiredData } from '../file.test-samples';
...
describe('File Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'b4cda08e-50b3-4383-a397-04fa73612acd' }], {
    ...
    expect(comp.files()[0]).toEqual(expect.objectContaining({ id: 'b4cda08e-50b3-4383-a397-04fa73612acd' }));
  });
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: 'b4cda08e-50b3-4383-a397-04fa73612acd' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    successReq.flush([{ id: 'b4cda08e-50b3-4383-a397-04fa73612acd' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  describe('trackId', () => {
    it('should forward to fileService', () => {
      const entity = { id: 'b4cda08e-50b3-4383-a397-04fa73612acd' };
      vitest.spyOn(service, 'getFileIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.filesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
  ...
  it('should calculate the filter attribute', () => {
    ...
    // THEN
    expect(service.filesParams()).toMatchObject(expect.objectContaining({ 'someId.in': ['dc4279ea-cfb9-11ec-9d64-0242ac120002'] }));
  });
